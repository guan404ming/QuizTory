import {
  ...
  export const settingTable = pgTable(
    "SETTING",
    {
      ...
      date: date("setting_date").primaryKey().notNull(),
      time: time("setting_time").primaryKey().notNull(),
      userId: serial("user_id")
        .notNull()
        .references(() => userTable.id, { onDelete: "cascade" }),
    },
  ...
  export const activityRecordTable = pgTable(
    "ACTIVITY_RECORD",
    {
      ...
      date: date("activity_date").primaryKey().notNull(),
      time: time("activity_time").primaryKey().notNull(),
  ...
  export const roleChangedRecord = pgTable(
    "ROLE_CHANGED_RECORD",
    {
      ...
      date: date("changed_date").primaryKey().notNull(),
      time: time("changed_time").primaryKey().notNull(),
